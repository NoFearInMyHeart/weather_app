  ...
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      ...
      <ul class="absolute bg-weather-secondary text-white w-full shadow-md py-2 px-1 top-[66px]" v-if="mapboxSearchResults">
        ...
        <template v-else>
          <li v-for="item in mapboxSearchResults" :key="item.id"
...
const mapboxAPIKey = "pk.eyJ1Ijoiemh1eXVlemUiLCJhIjoiY2xiOTYzdHM3MHJsdDN0cnYyc3ZoMThzYSJ9.GbStfhs9IeH-6dS-wckTrg";
